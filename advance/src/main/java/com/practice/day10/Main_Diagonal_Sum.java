...
public class Main_Diagonal_Sum {
    ...
    public static void main(String[] args) {
        Main_Diagonal_Sum mainDiagonalSum = new Main_Diagonal_Sum();
        System.out.println(mainDiagonalSum.mainDiagonalSum(new int[][]{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}}));
    }

    public int mainDiagonalSum(int[][] A){
        int sum = 0;
