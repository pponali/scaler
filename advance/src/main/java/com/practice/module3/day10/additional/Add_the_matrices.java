package com.practice.module3.day10.additional;
...
public class Add_the_matrices {
    ...
    public static void main(String[] args) {
        Add_the_matrices addTheMatrices = new Add_the_matrices();
        int[][] A = new int[][]{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
        int[][] B = new int[][]{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
        System.out.println(Arrays.deepToString(addTheMatrices.addTheMatrices(A, B)));
    }

    public int[][] addTheMatrices(int[][] A, int[][] B){
